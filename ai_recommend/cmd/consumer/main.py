# from ai_recommend.adapter.input.e_commerce.e_commerce_events_consumer import (
...
#
# def main(
#     consumer: ECommerceEventsConsumer = Provide[
#         CmdContainer.e_commerce_events_consumer
#     ],
# ):
#     """
